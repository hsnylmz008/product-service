package com.hsnylmz.stockmanagement.productservice.exception.utils;

import com.hsnylmz.stockmanagement.productservice.enums.Language;
import com.hsnylmz.stockmanagement.productservice.exception.enums.IFriendlyMessageCode;
...
public class FriendlyMessageUtils {
    ...
    public static String getFriendlyMessage(Language language, IFriendlyMessageCode messageCode){
        ...
        try {
            ...
            log.error("Friendly mesaage not found for key: {}", messageKey);
            return null;
        }
    }
}
